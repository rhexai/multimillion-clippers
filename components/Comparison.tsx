export default function Comparison() {
  return (
    <section className="py-24 px-6 md:px-12 max-w-7xl mx-auto flex flex-col items-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-16 w-full p-2 bg-[#F6F8FA] rounded-[40px]">
        {/* Other Notetakers */}
        <div className="bg-[#EAECEF] rounded-[32px] p-10 flex flex-col items-center pt-16 relative overflow-hidden">
          ...
          <div className="w-[80%] aspect-video bg-[#325AC6] rounded-2xl flex items-center justify-center relative shadow-lg">
        ...
        {/* Cluely */}
        <div className="bg-[#606478] rounded-[32px] p-10 flex flex-col items-center pt-16 relative overflow-hidden text-center">
          ...
          <div className="w-[80%] aspect-video bg-[#4B4E61] rounded-2xl flex relative overflow-hidden shadow-2xl border border-white/10">
             <div className="absolute inset-0 flex">
                ...
                <div className="w-1/2 h-full relative overflow-hidden flex items-center justify-center">
                   {/* Striped overlay pattern to show invisibility */}

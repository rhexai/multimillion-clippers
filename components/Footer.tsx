export default function Footer() {
  return (
    <footer className="w-full bg-[#F3F5F7] pt-24 pb-8 px-6 md:px-12 relative overflow-hidden mt-12 border-t border-gray-200/30">
      <div className="max-w-7xl mx-auto flex flex-col pt-10 relative z-10">
        ...
        <div className="w-full flex flex-col md:flex-row items-center justify-between gap-12 mb-24 relative">
          <div className="flex-1 text-center md:text-left">
            <h2 className="text-4xl md:text-[56px] font-semibold text-[#1C1D20] mb-3 leading-[1.1] tracking-tighter">
        ...
        <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 py-20 border-t border-gray-300">
          ...
          <div className="flex flex-col items-start justify-between gap-12">
            <div className="flex items-center gap-2 text-2xl font-bold text-[#1C1D20] tracking-tight">
              <div className="w-7 h-7 rounded-sm bg-[#1C1D20] text-white flex items-center justify-center text-[10px] pb-0.5 font-bold">C</div>
              Cluely
            </div>
            
            <div className="flex flex-col gap-5">
              <div className="bg-white px-4 py-2 rounded-xl flex items-center gap-2.5 text-[13px] text-gray-700 font-bold border border-gray-200/50 shadow-sm">
                <div className="w-2 h-2 rounded-full bg-[#22C55E] animate-pulse"></div> 
                All systems operational
              </div>
              <p className="text-gray-400 text-[13px] font-semibold">
                List of <a href="#" className="text-[#4D8AF0] hover:text-blue-700 underline underline-offset-4 decoration-1 decoration-[#4D8AF0]/30 transition-colors">subprocessors.</a>
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-6">
            <h4 className="font-bold text-[#1C1D20] text-base">Resources</h4>
            <nav className="flex flex-col gap-4 text-[#6B6D76] text-sm font-bold">
              <a href="#" className="hover:text-black transition-colors flex items-center gap-2">
                Mobile <span className="bg-[#4D8AF0] text-white text-[9px] px-2 py-0.5 rounded-full uppercase tracking-tighter">New</span>
              </a>
              ...
              <a href="#" className="hover:text-black transition-colors">Bug Bounty</a>
            </nav>
          </div>
          ...
          <div className="flex flex-col gap-6">
            <h4 className="font-bold text-[#1C1D20] text-base">Legal</h4>
            <nav className="flex flex-col gap-4 text-[#6B6D76] text-sm font-bold">
              <a href="#" className="hover:text-black transition-colors">Privacy Policy</a>
              <a href="#" className="hover:text-black transition-colors">Terms of Service</a>
              <a href="#" className="hover:text-black transition-colors">Subprocessors</a>
            </nav>
          </div>
        </div>
        ...
        <div className="w-full flex flex-col md:flex-row justify-between items-center py-8 border-t border-gray-300 gap-6">
          <p className="text-gray-400 text-sm font-semibold">© 2026 Cluely. All rights reserved.</p>

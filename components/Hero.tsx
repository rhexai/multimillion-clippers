...
export default function Hero() {
  return (
    <section className="relative pt-32 pb-20 px-6 hero-gradient overflow-hidden min-h-[90vh] flex flex-col items-center justify-start text-center">
      {/* Decorative sun/glow behind mountains, implemented via css shadow/radial gradient */}
      ...
      <div className="relative z-10 max-w-4xl mx-auto flex flex-col items-center pt-10">
        <h1 className="text-5xl md:text-7xl font-medium tracking-tight text-white mb-6 leading-[1.1] hero-text-gradient drop-shadow-sm">
          #1 Undetectable<br />AI for Meetings
        </h1>
        <p className="text-lg md:text-xl text-white/90 max-w-2xl mx-auto font-medium mb-8 drop-shadow-sm">
      ...
      {/* Mockup section */}
      <div className="relative z-20 w-full max-w-5xl mx-auto -mb-32 md:-mb-48 perspective-[1000px]">
        <div className="glass-panel w-full aspect-[16/10] rounded-t-3xl md:rounded-t-[40px] border-b-0 shadow-2xl p-2 md:p-4 flex flex-col relative overflow-hidden bg-white/10">
           ...
           <div className="flex-1 bg-black rounded-2xl md:rounded-[24px] overflow-hidden relative flex">
              ...
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-4/5 md:w-[600px] glass-panel rounded-2xl p-6 shadow-2xl border border-white/20 bg-[#1C1D20]/80 backdrop-blur-3xl text-left">

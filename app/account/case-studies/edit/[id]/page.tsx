...
import { updateCaseStudy, getCaseStudyById } from "@/app/actions/case-study";
      ...
      <div className="max-w-[1000px] mx-auto p-6 md:p-10 lg:p-12">
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-semibold text-[#0f172a]">Edit Case Study</h1>
              <p className="text-sm text-[#64748b]">Update your case study information</p>
            </div>
          </div>
        ...
        <div className="bg-white rounded-xl border border-[#e2e8f0] shadow-sm p-8">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {formData.image && (
              <div className="pt-2">
                <p className="text-sm font-medium text-[#475569] mb-2">Image Preview</p>
                <img src={formData.image} alt="Preview" className="h-48 rounded-lg object-cover border border-gray-200" />
              </div>
            )}
